...
export namespace browser {
	...
	export class ProfileBatchCreateInput {
	    count: number;
	    base: ProfileInput;
	    randomizeFingerprintPerProfile: boolean;
	
	    static createFrom(source: any = {}) {
	        return new ProfileBatchCreateInput(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.count = source["count"];
	        this.base = this.convertValues(source["base"], ProfileInput);
	        this.randomizeFingerprintPerProfile = source["randomizeFingerprintPerProfile"];
	    }
	...
	export class ProfileBatchCreateItemResult {
	    index: number;
	    profileName: string;
	    profile?: Profile;
	    error?: string;
	    ...
	    static createFrom(source: any = {}) {
	        return new ProfileBatchCreateItemResult(source);
	    }
	...
	export class ProfileBatchCreateResult {
	    total: number;
	    succeeded: number;
	    failed: number;
	    items: ProfileBatchCreateItemResult[];
	
	    static createFrom(source: any = {}) {
	        return new ProfileBatchCreateResult(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.failed = source["failed"];
	        this.items = this.convertValues(source["items"], ProfileBatchCreateItemResult);
	    }
	...
	export class ProfileTemplate {
	    ...
	    static createFrom(source: any = {}) {
	        return new ProfileTemplate(source);
	    }
	...
	export class ProfileTemplateInput {
	    templateName: string;
	    profileName: string;
	    userDataDir: string;
	    coreId: string;
	    ...
	    static createFrom(source: any = {}) {
	        return new ProfileTemplateInput(source);
	    }
